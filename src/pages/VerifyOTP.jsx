    ...
    <div className="h-screen overflow-hidden bg-white flex flex-col">
      ...
      <nav className="flex items-center justify-between px-8 py-5 border-b border-gray-100 flex-shrink-0">
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          <Link to="/forgot-password" className="bg-[#4A7C59] hover:bg-[#3d6b4a] text-white px-4 py-2 rounded-lg font-medium transition-colors">
            Go back
          </Link>
        </div>
      </nav>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-16">
          <div className="w-full max-w-sm">
            ...
            <p className="text-[#4A7C59] font-semibold text-sm mb-8 truncate">{email}</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 text-sm text-center tracking-[0.5em] font-bold outline-none transition-all focus:border-[#4A7C59] border-gray-100 hover:border-gray-200"
                />
              </div>
              ...
              <button type="submit" disabled={loading || otp.join('').length !== 6}
                className={`w-full py-3.5 rounded-xl font-semibold text-sm transition-all ${loading || otp.join('').length !== 6 ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-[#4A7C59] hover:bg-[#3d6b4a] text-white'}`}>
                {loading ? (
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 text-center space-y-2">
              ...
              <button type="button" onClick={handleResend} disabled={resendLoading || resendCooldown > 0}
                className={`text-sm font-medium transition-colors ${resendLoading || resendCooldown > 0 ? 'text-gray-300 cursor-not-allowed' : 'text-[#4A7C59] hover:text-[#3d6b4a] hover:underline'}`}>
