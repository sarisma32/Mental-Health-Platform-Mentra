      ...
      <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl overflow-hidden">
        <div className="flex justify-between items-center px-6 py-5 border-b border-gray-100">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#d0e8dc] rounded-full flex items-center justify-center">
        ...
        <div className="px-6 py-5 space-y-5 max-h-[75vh] overflow-y-auto">
          ...
          <div>
            ...
            {reviewRating > 0 && <p className="text-sm text-[#4A7C59] font-medium mt-2">{ratingLabels[reviewRating]}</p>}
          </div>
          ...
          <div>
            ...
            <textarea value={reviewText} onChange={e => setReviewText(e.target.value)} rows={4}
              ...
              className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-[#4A7C59] focus:border-transparent resize-none bg-white" />
          </div>
        </div>
        ...
        <div className="flex gap-3 px-6 py-4 border-t border-gray-100">
          ...
          <button onClick={handleSubmitReview} disabled={!reviewRating || submittingReview}
            className="flex-1 px-4 py-3 bg-[#4A7C59] hover:bg-[#3d6b4a] text-white rounded-xl text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-colors">
