...
import DoctorWarnings from './doctor/DoctorWarnings.jsx';
...
const DoctorDashboardNew = () => {
  ...
  const menuItems = [
    ...
    { id: 'emergency', name: 'Emergency', icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>, alert: true },
    { id: 'warnings', name: 'Admin Warnings', icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg> },
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <DashboardSidebar
        ...
        userPhoto={doctor.profile_photo ? (doctor.profile_photo.startsWith('http') ? doctor.profile_photo : `http://localhost:5002/${doctor.profile_photo}`) : null}
        userPrefix="Dr."
        menuItems={menuItems}
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-8">
          ...
          {activeSection === 'emergency' && doctor && (
            <DoctorEmergency doctorId={doctor.id} />
          )}

          {activeSection === 'warnings' && doctor && (
            <DoctorWarnings doctorId={doctor.id} />
          )}
