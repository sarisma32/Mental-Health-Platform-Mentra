            ...
            <div className="space-y-8">
              ...
              <div className="flex justify-center lg:justify-start">
                <div className="relative">
                  <img 
                    src="https://images.unsplash.com/photo-1555421689-491a97ff2040?w=400&h=400&fit=crop&crop=face" 
                    alt="Person feeling secure and confident" 
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  You're almost done! Create a strong, unique password that you'll 
                  remember. This will help keep your account and personal information 
                  secure as you continue your mental wellness journey.
                </p>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-mentra-primary focus:border-transparent transition-colors"
                      required
                      disabled={loading}
                    />
                    <button
                  ...
                  {formData.newPassword && (
                    <div className="mt-3">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className={`text-xs font-medium ${passwordStrength.score >= 4 ? 'text-mentra-primary' : 'text-gray-600'}`}>
                ...
                <div>
                  ...
                  {formData.confirmPassword && formData.newPassword === formData.confirmPassword && (
                    <p className="mt-1 text-sm text-mentra-primary flex items-center">
                      <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-full font-semibold transition-all duration-300 transform shadow-lg ${
                    loading || passwordStrength.score < 5 || formData.newPassword !== formData.confirmPassword
