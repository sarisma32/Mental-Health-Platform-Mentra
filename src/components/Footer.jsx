    ...
    <footer className="bg-[#2D3B2D] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-10">
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-[#4A7C59] mb-4">Navigation</h4>
            <ul className="space-y-2 text-sm text-[#B8C9A8]">
              <li><Link to="/" className="hover:text-[#4A7C59] transition-colors">Home</Link></li>
              <li><Link to="/about" className="hover:text-[#4A7C59] transition-colors">About Us</Link></li>
              <li><Link to="/services" className="hover:text-[#4A7C59] transition-colors">Services</Link></li>
              <li><Link to="/professionals" className="hover:text-[#4A7C59] transition-colors">Find Therapists</Link></li>
            </ul>
          </div>

          {/* Contact */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-[#4A7C59] mb-4">Contact</h4>
            <ul className="space-y-2 text-sm text-[#B8C9A8]">
