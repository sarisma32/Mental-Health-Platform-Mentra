      ...
      <section className="py-20 bg-mentra-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive support for various mental health challenges with evidence-based approaches
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Service 1 */}
            <div className="group bg-mentra-white border-2 border-mentra-secondary p-8 rounded-2xl text-center hover:border-mentra-primary hover:shadow-lg transition-all duration-300">
              <div className="text-5xl mb-6 group-hover:scale-110 transition-transform">😴</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Sleep Problems</h3>
              <p className="text-gray-600">Overcome insomnia and sleep disorders with expert guidance and proven techniques</p>
            </div>
            ...
            <div className="group bg-mentra-white border-2 border-mentra-secondary p-8 rounded-2xl text-center hover:border-mentra-primary hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">Professional support for managing depression and mood disorders with compassionate care</p>
            </div>
            ...
            <div className="group bg-mentra-white border-2 border-mentra-secondary p-8 rounded-2xl text-center hover:border-mentra-primary hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">Improve communication and resolve relationship challenges with expert guidance</p>
            </div>

            {/* Service 4 */}
            <div className="group bg-mentra-white border-2 border-mentra-secondary p-8 rounded-2xl text-center hover:border-mentra-primary hover:shadow-lg transition-all duration-300">
              <div className="text-5xl mb-6 group-hover:scale-110 transition-transform">😰</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Anxiety</h3>
              <p className="text-gray-600">Learn effective coping strategies for anxiety and panic disorders</p>
            </div>
            ...
            <div className="group bg-mentra-white border-2 border-mentra-secondary p-8 rounded-2xl text-center hover:border-mentra-primary hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Stress Management</h3>
              <p className="text-gray-600">Develop healthy ways to manage daily stress and life pressures</p>
            </div>

            {/* Service 6 - Additional service */}
            <div className="group bg-mentra-white border-2 border-mentra-secondary p-8 rounded-2xl text-center hover:border-mentra-primary hover:shadow-lg transition-all duration-300">
              <div className="text-5xl mb-6 group-hover:scale-110 transition-transform">🧠</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">ADHD Support</h3>
              <p className="text-gray-600">Specialized support for attention and focus challenges with practical strategies</p>
            </div>
          </div>
        </div>
      </section>
